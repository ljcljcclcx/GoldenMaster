 ...
 *
 */
public abstract class BaseAdapterAbs extends android.widget.BaseAdapter {
	...
	public BaseAdapterAbs() {
		this(null);
	}

	public BaseAdapterAbs(Activity mContext) {
		this(mContext, 10);
	}

	public BaseAdapterAbs(Activity mContext, int mPerPageSize) {
